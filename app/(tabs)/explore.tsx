...
export default function ExploreScreen() {
  ...
  return (
    <ParallaxScrollView
      ...
      headerImage={<Ionicons size={310 * scale} name="code-slash" style={styles.headerImage} />}>
      ...
      <Collapsible title="File-based routing">
        <ThemedText>
          This app has three screens: <ThemedText type="defaultSemiBold">app/(tabs)/index.tsx</ThemedText> (the home
          screen), <ThemedText type="defaultSemiBold">app/(tabs)/explore.tsx</ThemedText> (the &quot;Explore&quot;
          screen), and <ThemedText type="defaultSemiBold">app/(tabs)/tv_focus.tsx</ThemedText> (the TV event demo
          screen).
        </ThemedText>
        <ThemedText>
